...
export function FactorList({
  ...
  return (
    <div className="px-4 py-2" data-testid={`factor-list-${tone}`}>
      {factors.map((f) => (
        <div
          key={f.factorId}
        ...
        >
          <span className="mt-[3px] shrink-0" style={{ color }}>
            {tone === "positive" ? <IconArrowUp size={13} /> : <IconArrowDown size={13} />}
          </span>
          <span
            className="smp-num mt-[2px] w-[112px] shrink-0 text-[11.5px]"
...
export function FactorDisclaimer() {
  return (
    <div className="smp-disclaimer mx-4 mb-3 mt-1" data-testid="factor-disclaimer">
